...
def get_parser():
    ...
    parser.add_argument("--min_lr_rate", default=1.0, type=float, help="Minimal learning rate ratio")
    ...
    parser.add_argument("--batch_size", default=16, type=int, help="Batch size in training")
    parser.add_argument("--acc_grads", default=2, type=int,
    ...
    # Model settings
    parser.add_argument("--hidden_dims", default=[64, 64, 128, 128, 256, 256, 384, 384, 512, 512], nargs='+', type=int,
